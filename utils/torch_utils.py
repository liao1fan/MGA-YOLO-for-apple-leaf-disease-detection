    ...
    for x in input if isinstance(input, list) else [input]:
        ...
        for m in ops if isinstance(ops, list) else [ops]:
            ...
            try:
                ...
                # flops_log = FlopCountAnalysis(m, inputs=(x,))
                # flops = flops_log.total()
                #
                # print("flops_by_module", flops_log.by_module())
                # print("flops_by_operator", flops_log.by_operator())
...
def model_info(model, verbose=False, img_size=640):
    ...
    try:  # FLOPs
        ...
        flops = flops.total() / 1E9 * 2

        # flops_by_module = flops.by_module()
        # flops_by_operator = flops.by_operator()
        # print("flops_total : %.3f GFLOPs" , flops)
        # print("flops_by_module : " , flops_by_module)
        # print("flops_by_operator : " , flops_by_operator)
